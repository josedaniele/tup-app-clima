...
function ciudadesSelect() {
  ...
  if (ciudades.length != 0) {
    ...
    document.getElementById("form-city-list").innerText =
      "No hay ciudades cargadas, vaya a la seccion agregar ciudad";
...
function consulta() {
  ...
  console.log($cargando.style.display)
  fetch(url)
    ...
    .finally(() => {
      ...
      console.log("terminado", $cargando.style.display);
    });
}
